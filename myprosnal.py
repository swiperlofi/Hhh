...
MESSAGE = """NIHAL KE HATER KI BHN RANDI BANADU?😍😍"""
...
# =========================
BASE_DELAY = 0.07       # ultra fast - 1 message per 0.7 sec
BURST = 5               # send 5 messages per loop
RECYCLE_AFTER = 120     # page refresh per thread
RECYCLE_COOLDOWN = 1.0  # seconds
ERROR_BACKOFF = 1.0     # seconds
VERIFY_SETTLE_MS = 30   # minimal DOM settle
